   ...
   while(1)
   {
      ...
      if (dorun>0)
      {
         ...
         if(dorun == 50)
         {
            ...
            set_output_int16 ((uint16) 2, (uint8_t) 0, cubeMarsControlWords.removeError);
            set_output_int16 ((uint16) 3, (uint8_t) 0, cubeMarsControlWords.removeError);
         }
         if(dorun == 100)
         {
            ...
            set_output_int8 ((uint16) 2, (uint8_t) 1+2+2+2, (int8_t) 10); // set mode of operation to 100 (Cyclic Synchronous Torque CST)
            set_output_int16 ((uint16) 2, (uint8_t) 0, cubeMarsControlWords.prepare2Power);
            set_output_int8 ((uint16) 3, (uint8_t) 1+2+2+2, (int8_t) 10); // set mode of operation to 100 (Cyclic Synchronous Torque CST)
            set_output_int16 ((uint16) 3, (uint8_t) 0, cubeMarsControlWords.prepare2Power);
         }
         if(dorun == 150)
         {
            set_output_int16 (slave, (uint8_t) 0, cubeMarsControlWords.switchOn);

            set_output_int16 ((uint16) 2, (uint8_t) 0, cubeMarsControlWords.switchOn);
            set_output_int16 ((uint16) 3, (uint8_t) 0, cubeMarsControlWords.switchOn);
         }
         if(dorun == 200)
         {
            set_output_int16 (slave, (uint8_t) 0, (int16_t) 0x3F); // sets driver in ready to work 

            set_output_int16 ((uint16) 2, (uint8_t) 0, (int16_t) 0x3F); // sets driver in ready to work 
            set_output_int16 ((uint16) 3, (uint8_t) 0, (int16_t) 0x3F); // sets driver in ready to work 
         }
         if(dorun == 250)
         {
            set_output_int32 (slave, (uint8_t) 1+2+2, (int32_t) -6*10000); // sends target torque of 500

            set_output_int32 ((uint16) 2, (uint8_t) 1+2+2, (int32_t) -6*10000); // sends target torque of 500
            set_output_int32 ((uint16) 3, (uint8_t) 1+2+2, (int32_t) 12*10000); // sends target torque of 500
         }
         if(dorun == 1900)
         {
            set_output_int32 (slave, (uint8_t) 1+2+2, (int32_t) 1*10000); // sends target torque of 0

            set_output_int32 ((uint16) 2, (uint8_t) 1+2+2, (int32_t) 1*10000); // sends target torque of 0
            set_output_int32 ((uint16) 3, (uint8_t) 1+2+2, (int32_t) 1*10000); // sends target torque of 0
         }
         if(dorun == 1950)
         {
            set_output_int16 (slave, (uint8_t) 0, (int16_t) 0x0006); // disables the motor

            set_output_int16 ((uint16) 2, (uint8_t) 0, (int16_t) 0x0006); // disables the motor
            set_output_int16 ((uint16) 3, (uint8_t) 0, (int16_t) 0x0006); // disables the motor
         }
      }
      if (ec_slave[0].hasdc)
      {
      ...
      if ( ec_config_init(FALSE) > 0 )
      {
         ...
         if (ec_slave[0].state == EC_STATE_OPERATIONAL )
         {
            ...
            for(i = 1; i <= 5000; i++)
            {
               ...
               get_input_int32(slave, (uint8_t) 1+2+2,&torqueValue); // read current actual value
               get_input_int8(slave, (uint8_t) 1+2+2+2, &modeValue);
               printf("statusword %d ", statusValue);
               printf("Mode of operation %d ", modeValue);
               printf("Position Values %d ", positionValue);
               printf("Torque Actual Values %d \n", torqueValue/10000);
               fflush(stdout);
