...
void pdo_test_cpp(char *ifname)
{
    if (ec_init(ifname))
    {
      ...
      if ( ec_config_init(FALSE) > 0 )
      {
         ...
         if(ec_configdc() == true)
         {
            printf("DC config successed.\n");
         }
         else
         {
            printf("DC config filed.\n");
         ...
         // set to op
         printf("Request operational state for all slaves\n");
         expectedWKC = (ec_group[1].outputsWKC * 2) + ec_group[1].inputsWKC;
         printf("Calculated workcounter %d\n", expectedWKC);
         ...
         for(int i = 1; i <= 9000; i++)
         {
               ...
               wkc = ec_receive_processdata(EC_TIMEOUTRET);
                    ...
                    if(wkc >= expectedWKC)
                    {
                        ...
                        if(i > 50 && i < 60)
                        {
                           ec_slave[1].outputs[14] = 0x08;     //start  test position mode
                           ec_slave[2].outputs[14] = 0x08;     //start  test position mode
                           ec_slave[3].outputs[14] = 0x08;     //start  test position mode
                           ec_slave[4].outputs[14] = 0x08;     //start  test position mode
                           ec_slave[5].outputs[14] = 0x08;     //start  test position mode
                           ec_slave[6].outputs[14] = 0x08;     //start  test position mode
                           // ec_slave[1] : first motor in Ethercat chain
                           // outputs[2]-outputs[5] means the position bytes (float)
                           ec_slave[1].outputs[2] = 0X00;   
                           ec_slave[1].outputs[3] = 0X00;  
                           ec_slave[1].outputs[4] = 0X00;
                           ec_slave[1].outputs[5] = 0X00;         //turn 0rad
                           
                           ec_slave[2].outputs[2] = 0X00;
                           ec_slave[2].outputs[3] = 0X00;  
                           ec_slave[2].outputs[4] = 0X00;
                           ec_slave[2].outputs[5] = 0X00;         //turn 0rad

                           ec_slave[3].outputs[2] = 0X00;
                           ec_slave[3].outputs[3] = 0X00;  
                           ec_slave[3].outputs[4] = 0X00;
                           ec_slave[3].outputs[5] = 0X00;         //turn 0rad

                           ec_slave[4].outputs[2] = 0X00;
                           ec_slave[4].outputs[3] = 0X00;  
                           ec_slave[4].outputs[4] = 0X00;
                           ec_slave[4].outputs[5] = 0X00;         //turn 0rad

                           ec_slave[5].outputs[2] = 0X00;
                           ec_slave[5].outputs[3] = 0X00;  
                           ec_slave[5].outputs[4] = 0X00;
                           ec_slave[5].outputs[5] = 0X00;         //turn 0rad

                           ec_slave[6].outputs[2] = 0X00;
                           ec_slave[6].outputs[3] = 0X00;  
                           ec_slave[6].outputs[4] = 0X00;
                           ec_slave[6].outputs[5] = 0X00;         //turn 0rad

                           // outputs[6]-outputs[9] means the velocity(0x14f0)
                           ec_slave[1].outputs[6] = 0X40;
                           ec_slave[1].outputs[7] = 0X1f;
                           ec_slave[1].outputs[8] = 0X00;
                           ec_slave[1].outputs[9] = 0X00;           //0.8 rad/s
                           
                           ec_slave[2].outputs[6] = 0X40;
                           ec_slave[2].outputs[7] = 0X1f;
                           ec_slave[2].outputs[8] = 0X00;
                           ec_slave[2].outputs[9] = 0X00;           //0.8 rad/s

                           ec_slave[3].outputs[6] = 0X40;
                           ec_slave[3].outputs[7] = 0X1f;
                           ec_slave[3].outputs[8] = 0X00;
                           ec_slave[3].outputs[9] = 0X00;           //0.8 rad/s
                     
                           ec_slave[4].outputs[6] = 0X40;
                           ec_slave[4].outputs[7] = 0X1f;
                           ec_slave[4].outputs[8] = 0X00;
                           ec_slave[4].outputs[9] = 0X00;           //0.8 rad/s
                           
                           ec_slave[5].outputs[6] = 0X40;
                           ec_slave[5].outputs[7] = 0X1f;
                           ec_slave[5].outputs[8] = 0X00;
                           ec_slave[5].outputs[9] = 0X00;           //0.8 rad/s

                           ec_slave[6].outputs[6] = 0X40;
                           ec_slave[6].outputs[7] = 0X1f;
                           ec_slave[6].outputs[8] = 0X00;
                           ec_slave[6].outputs[9] = 0X00;           //0.8 rad/s
                        ...
                        {
                           // ec_slave[1].outputs[14] = 0x08;     //start  test position mode 
                           ec_slave[1].outputs[0] = 0x1f;      //outputts[0]-[1] means control word, 0x001F equals to motor mode
                           ec_slave[1].outputs[1] = 0x00;     
  
    
                           ec_slave[2].outputs[0] = 0x1f;
                           ec_slave[2].outputs[1] = 0x00;
  
                           // ec_slave[3].outputs[14] = 0x08;     //start  test position mode  
                           ec_slave[3].outputs[0] = 0x1f;
                           ec_slave[3].outputs[1] = 0x00;

                           // ec_slave[4].outputs[14] = 0x08;     //start  test position mode
                           ec_slave[4].outputs[0] = 0x1f;
                           ec_slave[4].outputs[1] = 0x00;
  
                           // ec_slave[5].outputs[14] = 0x08;     //start  test position mode
                           ec_slave[5].outputs[0] = 0x1f;
                           ec_slave[5].outputs[1] = 0x00;

                           // ec_slave[6].outputs[14] = 0x08;     //start  test position mode 
                           ec_slave[6].outputs[0] = 0x1f;
                           ec_slave[6].outputs[1] = 0x00;

                        }
                        if(i >= 400)
                        {
                           ec_slave[1].outputs[2] = 0Xa8;      // give the first target position
                           ec_slave[1].outputs[3] = 0X7a;  
                           ec_slave[1].outputs[4] = 0x00;
                           ec_slave[1].outputs[5] = 0X00;         //turn 10rad

                           // ec_slave[2].outputs[10] = 0X40;      // give the first target position
                           // ec_slave[2].outputs[11] = 0X0d;  
                           // ec_slave[2].outputs[12] = 0X03;
                           // ec_slave[2].outputs[13] = 0X00;         //turn 10rad

                           // ec_slave[3].outputs[10] = 0X40;      // give the first target position
                           // ec_slave[3].outputs[11] = 0X0d;  
                           // ec_slave[3].outputs[12] = 0X03;
                           // ec_slave[3].outputs[13] = 0X40;      // give the first target position
                           // ec_slave[4].outputs[11] = 0X0d;  
                           // ec_slave[4].outputs[12] = 0X03;
                           // ec_slave[4].outputs[13] = 0X00;         //turn 10rad

                           // ec_slave[5].outputs[10] = 0X40;      // give the first target position
                           // ec_slave[5].outputs[11] = 0X0d;  
                           // ec_slave[5].outputs[12] = 0X03;
                           // ec_slave[5].outputs[13] = 0X00;         //turn 10rad

                           // ec_slave[1].outputs[10] = 0X40;      // give the first target position
                           // ec_slave[1].outputs[11] = 0X0d;  
                           // ec_slave[1].outputs[12] = 0X03;
                           // ec_slave[1].outputs[13] = 0X00;         //turn 10rad
                        }

                        if (i >= 1300)
                        {
                           ec_slave[2].outputs[2] = 0Xa8;      // give the first target position
                           ec_slave[2].outputs[3] = 0X7a;  
                           ec_slave[2].outputs[4] = 0x00;
                           ec_slave[2].outputs[5] = 0X00;         //turn 10rad

                           // ec_slave[1].outputs[10] = 0xc0;      // give the first target position
                           // ec_slave[1].outputs[11] = 0xf2;  
                           // ec_slave[1].outputs[12] = 0xfc;
                           // ec_slave[1].outputs[13] = 0xff;         //turn 10rad
                           // ec_slave[2].outputs[2] = 0Xa8;
                           // ec_slave[2].outputs[3] = 0X7a;  
                           // ec_slave[2].outputs[4] = 0x00; 
                        }
                        ...
                        if (i >= 2200)
                        {
                           // ec_slave[1].outputs[10] = 0;      // give the first target position
                           // ec_slave[1].outputs[11] = 0;  
                           // ec_slave[1].outputs[12] = 0;
                           // ec_slave[1].outputs[13] = 0;         //turn 10rad
                           // ec_slave[2].outputs[10] = 0;      // give the first target position
                           // ec_slave[2].outputs[11] = 0;  
                           // ec_slave[2].outputs[12] = 0;
                           // ec_slave[2].outputs[13] = 0;         //turn 10rad

                           ec_slave[3].outputs[2] = 0Xa8;      // give the first target position
                           ec_slave[3].outputs[3] = 0X7a;  
                           ec_slave[3].outputs[4] = 0x00;
                           ec_slave[3].outputs[5] = 0X00;         //turn 10rad
                           // ec_slave[3].outputs[2] = 0Xa8;
                           // ec_slave[3].outputs[3] = 0X7a;  
                           // ec_slave[3].outputs[4] = 0x00;
                           // ec_slave[3].outputs[5] = 0X00;         //turn 10rad
                        }
                        ...
                        if (i == 3100)
                        {
                           // ec_slave[3].outputs[10] = 0;      // give the first target position
                           // ec_slave[3].outputs[11] = 0;  
                           // ec_slave[3].outputs[12] = 0;
                           // ec_slave[3].outputs[13] = 0;         //turn 10rad

                           ec_slave[4].outputs[2] = 0Xa8;      // give the first target position
                           ec_slave[4].outputs[3] = 0X7a;  
                           ec_slave[4].outputs[4] = 0x00;
                           ec_slave[4].outputs[5] = 0X00; 
                           // ec_slave[4].outputs[2] = 0Xa8;
                           // ec_slave[4].outputs[3] = 0X7a;  
                           // ec_slave[4].outputs[4] = 0x00;
                           // ec_slave[4].outputs[5] = 0X00;         //turn 10rad
                        }


                        if (i == 4000)
                        {
                           // ec_slave[4].outputs[10] = 0;      // give the first target position
                           // ec_slave[4].outputs[11] = 0;  
                           // ec_slave[4].outputs[12] = 0;
                           // ec_slave[4].outputs[13] = 0; 

                           ec_slave[5].outputs[2] = 0Xa8;      // give the first target position
                           ec_slave[5].outputs[3] = 0X7a;  
                           ec_slave[5].outputs[4] = 0x00;
                           ec_slave[5].outputs[5] = 0X00; 
                           // ec_slave[5].outputs[6] = 0X40;
                           // ec_slave[5].outputs[7] = 0X1f;
                           // ec_slave[5].outputs[8] = 0X00;
                           // ec_slave[5].outputs[9] = 0X00; 
                           // ec_slave[5].outputs[2] = 0Xa8;
                           // ec_slave[5].outputs[3] = 0X7a;  
                           // ec_slave[5].outputs[4] = 0x00;
                           // ec_slave[5].outputs[5] = 0X00;         //turn 10rad
                        }

                        if (i == 4900)
                        {
                           // ec_slave[5].outputs[10] = 0;      // give the first target position
                           // ec_slave[5].outputs[11] = 0;  
                           // ec_slave[5].outputs[12] = 0;
                           // ec_slave[5].outputs[13] = 0; 
                           ec_slave[6].outputs[2] = 0Xa8;
                           ec_slave[6].outputs[3] = 0X7a;  
                           ec_slave[6].outputs[4] = 0x00;
                           ec_slave[6].outputs[5] = 0X00;         //turn 10rad
                        }
                        ...
                        if(i >= 8000)
                        {
                           ec_slave[1].outputs[0] = 0x07;   // 0x0007 means 'reset mode'
                           ec_slave[1].outputs[1] = 0x00;
                           ec_slave[2].outputs[0] = 0x07;   
                           ec_slave[2].outputs[1] = 0x00;
                           ec_slave[3].outputs[0] = 0x07;
                           ec_slave[3].outputs[1] = 0x00;
                           ec_slave[4].outputs[0] = 0x07;
                           ec_slave[4].outputs[1] = 0x00;
                           ec_slave[5].outputs[0] = 0x07;
                           ec_slave[5].outputs[1] = 0x00;
                           ec_slave[6].outputs[0] = 0x07;
                           ec_slave[6].outputs[1] = 0x00;
                        }
                     
                     for (size_t t = 0; t < 1; t++)
                     {
                        statusValue = (int16_t)(((uint16_t)ec_slave[1].inputs[0])|((uint16_t)ec_slave[1].inputs[1] << 8));
                        modeValue=ec_slave[1].inputs[14] ;
                        positionValue = ((uint32_t)ec_slave[t+1].inputs[2])|((uint32_t)ec_slave[t+1].inputs[3]<<8)|((uint32_t)ec_slave[t+1].inputs[4]<<16)|((uint32_t)ec_slave[t+1].inputs[5]<<24);
                        velocityValue = ((uint32_t)ec_slave[t+1].inputs[6])|((uint32_t)ec_slave[t+1].inputs[7]<<8)|((uint32_t)ec_slave[t+1].inputs[8]<<16)|((uint32_t)ec_slave[t+1].inputs[9]<<24);
                        torqueValue =   ((uint32_t)ec_slave[t+1].inputs[10])|((uint32_t)ec_slave[t+1].inputs[11]<<8)|((uint32_t)ec_slave[t+1].inputs[12]<<16)|((uint32_t)ec_slave[t+1].inputs[13]<<24);
                        printf("\n");
                        printf("Number %d",t+1);
