         ...
         for(int i = 1; i <= 9000; i++)
         {
               ...
               wkc = ec_receive_processdata(EC_TIMEOUTRET);
                    ...
                    if(wkc >= expectedWKC)
                    {
                        ...
                        if(i > 50 && i < 60)
                        {
                           ec_slave[1].outputs[14] = 0x0a;     //start  test torque mode
                           ec_slave[2].outputs[14] = 0x0a;     //start  test torque mode
                           ec_slave[3].outputs[14] = 0x0a;     //start  test torque mode
                           ec_slave[4].outputs[14] = 0x0a;     //start  test torque mode
                           ec_slave[5].outputs[14] = 0x0a;     //start  test torque mode
                           ec_slave[6].outputs[14] = 0x0a;     //start  test torque mode
                           // ec_slave[1] : first motor in Ethercat chain
                           // outputs[2]-outputs[5] means the position bytes (float)
                           ec_slave[1].outputs[10] = 0X00;   
                           ec_slave[1].outputs[11] = 0X00;  
                           ec_slave[1].outputs[12] = 0X00;
                           ec_slave[1].outputs[13] = 0X00;         //turn 0NM
                           
                           ec_slave[2].outputs[10] = 0X00;
                           ec_slave[2].outputs[11] = 0X00;  
                           ec_slave[2].outputs[12] = 0X00;
                           ec_slave[2].outputs[13] = 0X00;         //turn 0NM

                           ec_slave[3].outputs[10] = 0X00;
                           ec_slave[3].outputs[11] = 0X00;  
                           ec_slave[3].outputs[12] = 0X00;
                           ec_slave[3].outputs[13] = 0X00;         //turn 0NM

                           ec_slave[4].outputs[10] = 0X00;
                           ec_slave[4].outputs[11] = 0X00;  
                           ec_slave[4].outputs[12] = 0X00;
                           ec_slave[4].outputs[13] = 0X00;         //turn 0NM

                           ec_slave[5].outputs[10] = 0X00;
                           ec_slave[5].outputs[11] = 0X00;  
                           ec_slave[5].outputs[12] = 0X00;
                           ec_slave[5].outputs[13] = 0X00;         //turn 0NM

                           ec_slave[6].outputs[10] = 0X00;
                           ec_slave[6].outputs[11] = 0X00;  
                           ec_slave[6].outputs[12] = 0X00;
                           ec_slave[6].outputs[13] = 0X00;         //turn 0NM
                        ...
                        if (i >= 1300)
                        {
                           ...
                           ec_slave[1].outputs[10] = 0X00;     // stop the first motor
                           ec_slave[1].outputs[11] = 0X00;  
                           ec_slave[1].outputs[12] = 0X00;
                           ec_slave[1].outputs[13] = 0X00;    
                        }
                        ...
                        if (i >= 2200)
                        {
                           ...
                           ec_slave[3].outputs[11] = 0X0d;  
                           ec_slave[3].outputs[12] = 0X03;
                           ec_slave[3].outputs[13] = 0X00;         //turn 10rad
                           
                           ec_slave[2].outputs[10] = 0X00;     // stop the first motor
                           ec_slave[2].outputs[11] = 0X00;  
                           ec_slave[2].outputs[12] = 0X00;
                           ec_slave[2].outputs[13] = 0X00;  
                        }

                        if (i >= 3100)
                        {
                           ec_slave[4].outputs[10] = 0X40;      // give the first target position
                           ec_slave[4].outputs[11] = 0X0d;  
                           ec_slave[4].outputs[12] = 0X03;
                           ec_slave[4].outputs[13] = 0X00; 

                           ec_slave[3].outputs[10] = 0X00;     // stop the first motor
                           ec_slave[3].outputs[11] = 0X00;  
                           ec_slave[3].outputs[12] = 0X00;
                           ec_slave[3].outputs[13] = 0X00;  
                        ...
                        if (i >= 4000)
                        {
                           ...
                           ec_slave[5].outputs[11] = 0X0d;  
                           ec_slave[5].outputs[12] = 0X03;
                           ec_slave[5].outputs[13] = 0X00; 

                           ec_slave[4].outputs[10] = 0X00;     // stop the first motor
                           ec_slave[4].outputs[11] = 0X00;  
                           ec_slave[4].outputs[12] = 0X00;
                           ec_slave[4].outputs[13] = 0X00;  
                        ...
                        if (i >= 4900)
                        {
                           ec_slave[6].outputs[10] = 0X40;
                           ec_slave[6].outputs[11] = 0X0d;  
                           ec_slave[6].outputs[12] = 0X03;
                           ec_slave[6].outputs[13] = 0X00;         //turn 10rad

                           ec_slave[5].outputs[10] = 0X00;     // stop the first motor
                           ec_slave[5].outputs[11] = 0X00;  
                           ec_slave[5].outputs[12] = 0X00;
                           ec_slave[5].outputs[13] = 0X00;  
                        }
